...
The 2024 New York City mayoral candidate entered the race strong but fell short in the end, losing by around 31,000 votes citywide. The campaign collected data across all five boroughs to understand what worked, what did not, and where opportunities may exist for any future mayoral run.

The analysis below looks at results by district and income level, the effectiveness of the Get Out the Vote (GOTV) operation, and what those surveyed said about the candidate's policy positions.
...
Despite winning 36 of 59 community districts, the loss was driven by decisive defeats in high-turnout, high-income districts that outweighed the candidate's strength in the Bronx and Brooklyn boroughs. High income districts outweighed the Bronx and Brooklyn strength by nearly 50,000 votes. Breaking even in just those 9 districts would have flipped the entire race.
...
```js
const mapWrapper = html`<div style="border: 1px solid #2a3a4a; border-radius: 8px; padding: 1rem; background: #0d1117;">
  ${mapPlot}
</div>`;
display(mapWrapper);
```
...
display(html`<div style="border: 1px solid #2a3a4a; border-radius: 8px; padding: 1rem; background: #0d1117;">
  ${gotvPlot}
</div>`);
```
...
Post election survey responses reveal a candidate whose policy platform was broadly popular except on police reform. 
...
**Police reform** alignment was low across the board, averaging just 1.43 out of 5 among all respondents, with no one scoring it above 2. Open-ended responses repeatedly named police reform as a dealbreaker even among voters who liked everything else about the candidate. 
...
<div style="margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 1px solid #2a3a4a;">
  ...
  <p style="font-size: 16px; line-height: 1.8; color: #cdd9e5; margin: 0;">This report presents findings from election results across 59 community districts, a post election survey of 100 registered voters, and campaign event data covering May through November 2024. All findings are driven by the provided data. Recommendations are specific and actionable.</p>
</div>
...
<div style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #2a3a4a; margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 1px solid #2a3a4a;">
  ...
  <p style="font-size: 16px; line-height: 1.8; color: #cdd9e5; margin: 0 0 1rem;">The candidate's coalition was geographically concentrated but was not broad. The Bronx and Brooklyn delivered strong results, with 11 of 12 and 15 of 18 districts won respectively. Manhattan, Queens, and Staten Island went substantially against the candidate.</p>
...
<div style="margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 1px solid #2a3a4a;">
  ...
  <p style="font-size: 16px; line-height: 1.8; color: #cdd9e5; margin: 0 0 1rem;">Income tier is the single strongest predictor of district level outcomes. The candidate swept every low-income district and lost every high-income district. 
  
  Middle-income districts are the strategic battleground.</p>
  <table style="width: 100%; border-collapse: collapse; font-size: 15px; margin-bottom: 1rem;">
    <thead>
      <tr style="background: #1f3864;">
...
<div style="margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 1px solid #2a3a4a;">
  ...
  <p style="font-size: 16px; line-height: 1.8; color: #cdd9e5; margin: 0;"><strong style="color: #c0392b;">Police Reform Finding:</strong> Every survey respondent scored police reform alignment at 1 or 2 out of 5. No respondent scored it above 2. Open-ended responses repeatedly named it as a dealbreaker even among voters who supported the rest of the platform. This is not a messaging problem. This position is a clear liability.</p>
</div>
...
<div style="margin-bottom: 2rem;">
  ...
  <div style="margin-bottom: 1.25rem; padding: 1rem; background: #111820; border-left: 4px solid #4fc3f7; border-radius: 3px;">
    ...
    <p style="font-size: 16px; line-height: 1.8; color: #cdd9e5; margin: 0 0 0.5rem;">This is the highest priority recommendation. The current position is losing voters the candidate cannot afford to lose. The campaign should research to identify a modified position that retains progressive values while reducing the alienation effect seen in the survey data. If the position cannot be substantively modified, it should be deprioritized in public facing messaging and not featured in advertising, debates, or candidate-led events unless directly challenged.</p>
    <ul style="font-size: 15px; color: #8ba7bf; margin: 0; padding-left: 1.2rem; line-height: 1.8;">
      <li>Police reform is the only issue where candidate and opponent voters are statistically identical, meaning the position provides no electoral benefit while creating documented defections.</li>
  ...
  <div style="margin-bottom: 1.25rem; padding: 1rem; background: #111820; border-left: 4px solid #e6a020; border-radius: 3px;">
    ...
    <ul style="font-size: 15px; color: #8ba7bf; margin: 0; padding-left: 1.2rem; line-height: 1.8;">
      ...
      <li>Candidate hours in high-income districts showed a negative correlation with vote share (-0.37), suggesting diminishing or counterproductive returns in those areas.</li>
    </ul>
  </div>
